            ...
            <div>
              ...
              >
                ...
                {!isEditingPassword ? (
                  <Buttons
                    type="button"
                    onClickhandler={() => setIsEditingPassword(!isEditingPassword)}
                    className="bg-customRed w-fit px-4 py-2 rounded-md text-white"
                  >
                  ...
                  <div className="flex items-center gap-2">
                    <Buttons
                      type="submit"
                      className="bg-btnColor w-fit px-4 py-2 rounded-md text-white"
                    >
